...
(function ($) {
            ...
            if (col && col.editor) {
                ...
                if (_175) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _175,
                        target: _175.init(cell.find("td"), $.extend({height: opts.editorHeight}, _174)),
                        field: _172,
                        type: _173,
                        oldHtml: _176
                    });
    ...
    var _1c5 = $.extend({}, _1b7(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_1c6, _1c7) {
    ...
    $.fn.datagrid.parseOptions = function (_20b) {
        var t = $(_20b);
        return $.extend({}, $.fn.panel.parseOptions(_20b), $.parser.parseOptions(_20b, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _20e = {
        render: function (_20f, _210, _211) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 31,
        headerEvents: {mouseover: _83(true), mouseout: _83(false), click: _87, dblclick: _8e, contextmenu: _94},
        rowEvents: {mouseover: _97(true), mouseout: _97(false), click: _9f, dblclick: _aa, contextmenu: _af},
        rowStyler: function (_254, _255) {
        },
        loader: function (_256, _257, _258) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _256, dataType: "json", success: function (data) {
                    _257(data);
                }, error: function () {
        ...
        editors: _1c5,
        finder: {
            getTr: function (_259, _25a, type, _25b) {
                type = type || "body";
                _25b = _25b || 0;
